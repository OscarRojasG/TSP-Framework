...
def generate_train_data(instance_file, data_filename, input_adapter_config, output_adapter_config, num_workers=None, size=999999, only_initial_state=False, sparse=False):
